...
def _build_theme_name_aliases() -> dict[str, str]:
    ...
    extra_aliases = {
        "Light": ThemeEngine.DEFAULT_THEME_NAME,
        "Light Mode": ThemeEngine.DEFAULT_THEME_NAME,
        "亮色": ThemeEngine.DEFAULT_THEME_NAME,
        "亮色模式": ThemeEngine.DEFAULT_THEME_NAME,
        "浅色": ThemeEngine.DEFAULT_THEME_NAME,
        "浅色模式": ThemeEngine.DEFAULT_THEME_NAME,
        "明亮": ThemeEngine.DEFAULT_THEME_NAME,
        "明亮模式": ThemeEngine.DEFAULT_THEME_NAME,
        "雅致亮色": ThemeEngine.DEFAULT_THEME_NAME,
        "白天模式": ThemeEngine.DEFAULT_THEME_NAME,
        "日间模式": ThemeEngine.DEFAULT_THEME_NAME,
        "Dark": "Dark Mode (OLED)",
        "Dark Mode": "Dark Mode (OLED)",
        "OLED": "Dark Mode (OLED)",
        "OLED Black": "Dark Mode (OLED)",
        "深色": "Dark Mode (OLED)",
        "深色模式": "Dark Mode (OLED)",
        "暗色": "Dark Mode (OLED)",
        "暗色模式": "Dark Mode (OLED)",
