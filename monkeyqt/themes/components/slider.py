# -*- coding: utf-8 -*-
"""ThemedSlider — theme-aware slider with value label."""
...
from ..style_utils import darken, lighten, parse_px, readable_text


class ThemedSlider(QWidget):
    """A compact slider wrapper that mirrors MonkeyQt's value-label ergonomics."""
